<template>
  <div v-on:keyup="setKeyControl">
    ...
    <a href="#" v-on:click.prevent="setKeyControl(37)" class="thumbs-control thumbs-control--left" v-if="isShowed && (thumbs.length > 1)"></a>
    <a href="#" v-on:click.prevent="setKeyControl(39)" class="thumbs-control thumbs-control--right" v-if="isShowed && (thumbs.length > 1)"></a>
  </div>
</template>
